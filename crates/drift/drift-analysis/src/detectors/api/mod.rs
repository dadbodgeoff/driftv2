...
impl Detector for ApiDetector {
    ...
    fn detect(&self, ctx: &DetectionContext) -> Vec<PatternMatch> {
        ...
        for call in ctx.call_sites {
            ...
            // Match direct method calls like app.get(), router.post(), etc.
            if rest_methods.contains(&callee_lower.as_str()) {
                ...
                matches.push(PatternMatch {
                    ...
                    matched_text: format!("{} route handler: {}", method_upper, call.callee_name),
                });
            }
        }
        ...
        let api_frameworks = ["express", "fastify", "koa", "hapi", "restify", "flask", "django", "actix-web", "axum", "rocket"];
